    ...
    <Sheet
      ...
      header={
        <div className="flex items-start gap-2 px-1">
          ...
          <button
            type="button"
            // Stop the press from starting a sheet drag.
            onPointerDown={(e) => e.stopPropagation()}
            onClick={onDismiss}
            aria-label="Close results"
            className="-mt-0.5 -mr-1 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-zinc-500/10 text-zinc-500 transition hover:bg-zinc-500/20 active:scale-95"
          >
